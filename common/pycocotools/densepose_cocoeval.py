...
from common.pycocotools import mask as maskUtils
import copy
import pickle
...
class denseposeCOCOeval:
    ...
    def _loadGEval(self):
        ...
        prefix = '/opt/hdfs/user/xinze.chen/common/dataset/densepose/annotations/'
    ...
    def summarize(self):
        ...
        def _summarize( ap=1, iouThr=None, areaRng='all', maxDets=100 ):
            ...
            logging.info(iStr.format(titleStr, typeStr, measure, iouStr, areaRng, maxDets, mean_s))
            return mean_s
        def _summarizeDets():
            stats = np.zeros((12,))
